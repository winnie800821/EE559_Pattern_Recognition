...
print('The classification of ',(trainaccuracy),'points in training data are correct. The accuracy of training data is :',(training_accuracyrate)) #The accuracy of training data
...
print('The classification of ',(testaccuracy),'points in testing data are correct. The accuracy of testing data is :',(testing_accuracyrate)) #The accuracy of training data
