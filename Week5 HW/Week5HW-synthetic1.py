...
training_data = np.loadtxt(open("synthetic1_train.csv"),delimiter=",")
...
print("The error rate of training data %.5f" % errorrate)
...
##############testing
testing_data = np.loadtxt(open("synthetic1_train.csv"),delimiter=",")
